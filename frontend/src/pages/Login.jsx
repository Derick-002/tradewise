              ...
              <form onSubmit={handleSubmit} className="w-full max-w-md flex flex-col gap-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-md font-medium text-gray-700 flex items-center gap-2">
                      Business Email
                    </label>
                    <input
                      type="email"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="password" className="text-md font-medium text-gray-700 flex items-center gap-2">
                      Password
                    </label>
